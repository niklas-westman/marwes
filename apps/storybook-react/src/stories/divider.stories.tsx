...
const meta = {
  ...
  argTypes: {
    size: {
      ...
      description:
        "Size variant (xxs=1px, xs=8px, sm=16px, md=32px, lg=48px, xl=64px, xxl=80px)",
    },
    orientation: {
      control: "select",
  ...
  render: () => (
    <div style={{ maxWidth: "600px" }}>
      ...
      <Paragraph style={{ margin: "0 0 1rem 0" }}>
        This is the first section of content. It contains some introductory text
        that explains the purpose of this section.
      </Paragraph>
      ...
      <Paragraph style={{ margin: "0 0 1rem 0" }}>
        This is the second section. The divider above visually separates it from
        the previous content while maintaining semantic meaning.
      </Paragraph>
      ...
      <Paragraph style={{ margin: "0" }}>
        Final section of content. Dividers help organize information and improve
...
export const VisualHierarchy: Story = {
  render: () => (
    <div style={{ maxWidth: "600px" }}>
      ...
      <Paragraph style={{ margin: "0" }}>
        Minor details separated by a thin divider.
      </Paragraph>
      <Divider size="xxs" />
    </div>
  ),
