/**
 * React Drawer story taxonomy guard — verifies Storybook title hierarchy.
 */
...
describe("React drawer story taxonomy", () => {
  it("keeps the component story under Drawer/Atom", () => {
    expect(readStoryFile("drawer.stories.tsx")).toContain('title: "Drawer/Atom"')
  })
