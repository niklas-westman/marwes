/**
 * React Skeleton story taxonomy guard — verifies that story files
...
describe("React skeleton story taxonomy", () => {
  it("keeps atom story under Skeleton/Atom", () => {
    const story = readFileSync(path.join(storiesDir, "skeleton.stories.tsx"), "utf8")
