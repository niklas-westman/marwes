...
import type { DatePickerFieldProps } from "@marwes-ui/vue"
...
const meta = {
  ...
  component: DatePickerField as unknown as object,
  parameters: {
...
} satisfies Meta<DatePickerFieldProps>

export default meta

type Story = StoryObj<DatePickerFieldProps>
