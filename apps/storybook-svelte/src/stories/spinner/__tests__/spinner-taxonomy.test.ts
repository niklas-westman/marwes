/**
 * Svelte Spinner story taxonomy guard — verifies that story files
...
describe("Svelte spinner story taxonomy", () => {
  ...
  it("keeps spinner compositions under Spinner/Molecule", () => {
    ...
    expect(buttonSpinnerStory).toContain("ButtonSpinnerStory")
