...
export const firstEditionThemeVarPaths: Record<string, string> = {
  ...
  "--mw-color-status-info-border-strong": "color.status.info.borderStrong",
  ...
  "--mw-color-status-success-border-strong": "color.status.success.borderStrong",
  ...
  "--mw-color-status-warning-border-strong": "color.status.warning.borderStrong",
  ...
  "--mw-color-status-error-border-strong": "color.status.error.borderStrong",
